...
public class Type
{
  ...
  /// <summary>
  /// Maps a PokeApiNet.Type to a PokeQuiz.Type
  /// </summary>
  /// <param name="type">The PokeApiNet.Type</param>
  /// <returns>The PokeQuiz.Type</returns>
  public static Type FromPokeApiNetResource(PokeApiNet.Type type)
  {
    return new Type
    {
      Id = type.Id,
      Name = type.Name,
      Names = type.Names.Select(name => new InternationalName { Name = name.Name, Language = name.Language.Name }).ToList()
    };
  }
}
